...
<h2 class="calendario">Calendario</h2>
<div id="calendario">
            ...
            <thead>
                    <tr>
                            ...
                            <td class="month_name" colspan="5">
                                <?php echo ucfirst(date_i18n('F ', $calendar['month_start'])); ?><br/>
                                <span><?php echo ucfirst(date_i18n('Y', $calendar['month_start'])); ?></span>
            ...
            <tbody>
                    ...
                    <tr>
                            ...
                            foreach($calendar['cells'] as $date => $cell_data ){
                                    ...
                                    ?>
                                    <td class="<?php echo $class . ' ' ;  if ( !empty($cell_data['events']) ){
                                            }
                                    ?>">
                                            <?php $i = 0; ?>
                                            <?php foreach( $cell_data['events'] as $EM_Event ){

                                                  $categoria = $EM_Event->output("#_CATEGORYSLUG");
                                                  $color = $EM_Event->output("#_CATEGORYCOLOR");
                                                  if($i<=1) {
                                                      echo '<span class="evento'.$i . ' ' .$categoria .'" style="border-top: 15px solid '. $color . ' "></span>';
                                                  }
